  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Kuesioner Siswa</li>
      </ol>

      <!-- Content -->
      <div>
        <div class="jumbotron">
          <a href="<?= base_url('app/inputKuesioner'); ?>" class="btn btn-info">Add(+)</a>
          <br><br>
          <table class="table table-bordered" id="myTable">
            ...
            <tbody>
            <?php $no=0 ;foreach ($siswa as $rows): $no++?>
               <tr>
                <td><?= $no ?></td>
                 ...
                 <td>
                   <a href="<?= base_url('app/detailSiswa/'.$rows->id); ?>" class="btn btn-primary btn-sm">Detail</a>
                 </td>
               </tr>
            <?php endforeach ?>
           </tbody>
