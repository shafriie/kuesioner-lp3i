      ...
      <div>
        <div class="jumbotron">
          ...
          <table class="table table-bordered">
            ...
            <?php $no=0 ;foreach ($sekolah as $rows): $no++?>
               <tr>
                <td><?= $no ?></td>
                 <td><?= $rows->nama_sekolah ?></td>
                 <td align="center">
                   <a id="<?= $rows->id_sekolah ?>" class="btn btn-danger btn-sm btn-edit">Edit</a>
                   &nbsp;
                   <a onclick="return confirm('Apakah anda ingin menghapus data ini?')" href="<?= base_url('app/sekolahAction/delete/'.$rows->id_sekolah); ?>" class="btn btn-primary btn-sm">Delete</a>
                 </td>
               </tr>
            <?php endforeach ?>
